...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('vectorclient/assets/new/blur.png')
...
local hash = loadstring(downloadFile('vectorclient/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('vectorclient/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('vectorclient/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('vectorclient/profiles/whitelist.json') and readfile('vectorclient/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('vectorclient/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('vectorclient/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('vectorclient/assets/new/radaricon.png'),
